...
class BaseVideoDataset(BaseDataset):
    ...
    def print_dataset_statistics(self, train, query, gallery):
        ...
        logger.info("  subset   | # ids | # images | # cameras")
        logger.info("  ----------------------------------------")
        logger.info("  train    | {:5d} | {:8d} | {:9d}".format(num_train_pids, num_train_tracklets, num_train_cams))
        logger.info("  query    | {:5d} | {:8d} | {:9d}".format(num_query_pids, num_query_tracklets, num_query_cams))
        logger.info("  gallery  | {:5d} | {:8d} | {:9d}".format(num_gallery_pids, num_gallery_tracklets, num_gallery_cams))
        logger.info("  ----------------------------------------")
